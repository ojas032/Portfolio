							...
							<div className="row">
								<div className="col-md-10">
									...
									<p className="section_detail">
										...
										I am intrested in Web Development and Competitive Programming.
										I also hold 4-star at Codechef and Specialist at Codeforces.
										I am extremely excited to explore plethora of jobs in my field.
										I am a Fast learner, hard worker and team player who is proficient in an array of programming languages.
										Looking for an opportunity to showcase my skills.
									</p>

									<button type="button" className="btn section_btn">
										<i className="fa fa-download"> </i>
										<a className="link" href="https://docs.google.com/document/d/1LubEDjryJRxwr3a3BIf3H5ClLfXBsVRk7_Is7QJSS6Y/edit"> Download CV</a>
									</button>
								</div>
							</div>
						</section>
						...
						<section className="container section" id="section2">
							<div className="row">
								<div className="col-md-10">
									...
									<p className="section_detail">
										Quest to work and learn in a real professional and vying ambience
